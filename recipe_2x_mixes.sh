...
python $SF $BRO_PAP  $((2 * rpgb / 2)) $rl >  seqs_mix8_2GB.fa.a &
python $SF $POA_PRA  $((2 * rpgb / 2)) $rl > seqs_mix8_2GB.fa.b & 

# Mix 9 = 10% Broussonetia papyrifera, 90% Poa pratensis
python $SF $BRO_PAP  $((2 * rpgb * 1 / 10)) $rl >  seqs_mix9_2GB.fa.a &
python $SF $POA_PRA  $((2 * rpgb * 9 / 10)) $rl > seqs_mix9_2GB.fa.b & 

# Mix 10 = 5% Broussonetia papyrifera, 95% Poa pratensis
python $SF $BRO_PAP  $((2 * rpgb *  1 / 20)) $rl >  seqs_mix10_2GB.fa.a &
python $SF $POA_PRA  $((2 * rpgb * 19 / 20)) $rl > seqs_mix10_2GB.fa.b & 

# Mix 11 = 1% Broussonetia papyrifera, 99% Poa pratensis
python $SF $BRO_PAP  $((2 * rpgb *  1 / 100)) $rl >  seqs_mix11_2GB.fa.a &
python $SF $POA_PRA  $((2 * rpgb * 99 / 100)) $rl > seqs_mix11_2GB.fa.b & 
